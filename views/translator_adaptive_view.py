...
class TranslatorAdaptiveView():
	def __init__(self, data_en, data_ru):
		...
		self.counter_word = len(data_en)
		self.theme_relief = 'groove'
		self.theme_bd = 4
		self.theme_bd_name = 2
		self.init_elements_frames()
		self.init_elements_list_words()
		self.init_elements_entry_user()
		self.init_elements_settings()
		self.init_elements_translate()
		self.init_elements_buttons()
		self.init_names_elements()
		self.run_loop_wait_translate()
